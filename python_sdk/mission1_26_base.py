...
FLEET_TRACE_SAMPLE_INTERVAL_SECONDS = 0.10
FLEET_TRACE_BUFFER_CAPACITY = 1200
FLEET_TRACE_MIN_DISTANCE_CM = 1.0
...
if __name__ == "__main__":
    raise RuntimeError(
        "mission1_26_base.py is a support module; run mission1_26.py"
    )
